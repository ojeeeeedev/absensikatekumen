...
const state = { secret: 'gas-secret', currentValue: false, lockAcquired: true, throwOnGet: false };
function load() {
...
describe('Apps Script GAS secret contract', () => {
  beforeEach(() => { state.secret = 'gas-secret'; state.currentValue = false; state.lockAcquired = true; state.throwOnGet = false; });
