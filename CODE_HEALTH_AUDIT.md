...
- Package metadata is now version 2.6.3-a and `classcode.json` contains five
...
| F-15 | Resolved: README, static fallbacks, package metadata, and project guidance now agree on v2.6.3-a and the authenticated private-photo proxy. |
...
- **Evidence:** `README.md:1` reports v2.4.5, the static UI fallbacks at
  ...
  `package.json:3` is 2.6.3-a. `README.md:21`, `README.md:45`, and the project
...
- Local `/api/version`: HTTP 200 with `{"version":"2.6.3-a"}`.
