...
- Every toast has a dismiss button, uses a frosted semantic border/fill, stays on one clipped line, and dismisses after five seconds without extending on hover/focus; no more than four remain visible.
